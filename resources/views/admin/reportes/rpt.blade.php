...
@endsection
@section('content')
<form id="form-reporte" method="post" action="{{route('admin.result',[$reporte])}}" autocomplete="off">
    @csrf
    <div class="form-row">
        <div class="col-12">
    ...
    <div class="form-group row">
      <div id="filtros" class="col-md-4">
        @foreach ($filtros as $filtro)
            @include('admin.reportes.filtro',['filtro'=>$filtro,'parametros'=>(isset($parametros) ? $parametros : null)])
        @endforeach
      </div>
