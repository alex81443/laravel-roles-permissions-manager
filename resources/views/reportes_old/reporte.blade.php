...
@section('content')
	<form
	action="@if(isset($list)){{route('reporte.update', [$id_rol_det, $list->id_rpt]) }}@else{{ route('reporte.store', [$id_rol_det])}}@endif"
	...
	<div class="row">
		...
		<div class="form-group col-xl-6 col-md-6 col-12">
			<div class="form-inline float-right">
				<a href="{{route('reporte.index', [$id_rol_det])}}" class="btn btn-lg btn-outline-secondary" role="button" data-toggle="tooltip" data-placement="top" title="Regresar">
				...
				<a href="@if(isset($list)){{route('reporte.delete', [$id_rol_det, $list->id_rpt])}}@else{{route('reporte.index',[$id_rol_det])}}@endif" class="btn btn-lg btn-outline-secondary" role="button" data-toggle="tooltip" data-placement="top" title="Eliminar">
		...
		<div class="form-group col-xl-4 col-md-4 col-12">
			...
			<select name="roles[]" id="roles" class="select2" multiple="multiple" required>
				@foreach ($roles as $rol)
					<option value="{{$rol->id_rol}}" @if(isset($list) && $list->roles->contains($rol->id_rol)) selected @endif >{{$rol->des}}</option>
				@endforeach
			</select>
		</div>
	</div>
